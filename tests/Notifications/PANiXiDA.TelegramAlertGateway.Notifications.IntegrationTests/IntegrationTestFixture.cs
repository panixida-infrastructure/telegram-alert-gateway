    ...
    public async ValueTask InitializeAsync()
    {
        ...
        var configuration = new ConfigurationBuilder()
            .AddInMemoryCollection(new Dictionary<string, string?>
            {
                ...
                ["AlertRouting:Rules:3:Matches:2"] = "kube-system",
                ["AlertRouting:Rules:3:Matches:3"] = "metrics-server",
                ["AlertRouting:Rules:3:Matches:4"] = "external-secrets",
                ["AlertRouting:Rules:3:Matches:5"] = "cert-controller",
